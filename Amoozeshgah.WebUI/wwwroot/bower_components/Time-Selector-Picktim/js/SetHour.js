...
'use strict';
    ...
    this.input = $('<input class="form-control ltrInput" name="Hour" id="Hour" data-val="true" data-val-required="ساعت را مشخص کنید" required>');
    ...
    this.cTable = $('<table>');
    this.cTable.addClass('picktim-table picktim-ltr');
